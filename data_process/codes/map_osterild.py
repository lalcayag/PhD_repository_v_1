...
c1, c2 = (14500)/x1d, (14750)/y1d

ax[0].xaxis.set_major_locator(plt.MultipleLocator(100*c1))
ax[0].xaxis.set_minor_locator(plt.MultipleLocator(50*c1))
ax[0].xaxis.set_major_formatter(plt.FuncFormatter(format_funcx))

ax[0].yaxis.set_major_locator(plt.MultipleLocator(600*c2))
ax[0].yaxis.set_minor_locator(plt.MultipleLocator(300*c2))
...
#    return u"${0:.2f} ^\circ\:E$".format(deg)
    ...
    return u"${0:.2f}$".format(c*(value-30000/2)/1000)
...
#    return u"${0:.2f} ^\circ\:N$".format(deg)
    c = 4300/7163.933783133118    
    return u"${0:.2f}$".format(c*(value-22500/2)/1000)
...
x1dm, y1dm = inProj(.5*(x1+x2), .5*(y1+y2), inverse=True)
x2d, y2d = inProj(x2, y2, inverse=True)
pt1 = mymap.plot([x1d,x2d], [y1d,y2d], 'ro', markersize=10, latlon=True, label = '$North\:and\:south$ \n $meteorological\:masts$')

fig.set_size_inches(16,8)

c1, c2 = (14500)/x1d, (14758)/y1d
x1dm, y1dm = 14758, 14443
x2dm, y2dm = 14443, 7221
...
ax[1].xaxis.set_major_locator(plt.MultipleLocator(5*c1))
ax[1].xaxis.set_minor_locator(plt.MultipleLocator(2.5*c1))
ax[1].xaxis.set_major_formatter(plt.FuncFormatter(format_funcx))

ax[1].yaxis.set_major_locator(plt.MultipleLocator(20*c2))
ax[1].yaxis.set_minor_locator(plt.MultipleLocator(10*c2))
