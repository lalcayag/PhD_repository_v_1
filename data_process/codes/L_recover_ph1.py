...
file_name0 = '/mnt/mimer/lalc/db/scans/phase_1/west/raw_filt_0_phase1.db'
file_name1 = '/mnt/mimer/lalc/db/scans/phase_1/west/raw_filt_1_phase1.db'
file_in_path = '/mnt/mimer/lalc/results/correlations/west/phase_1'
L_file = '/mnt/mimer/lalc/results/correlations/west/L_ph1.pkl'
file_out = '/mnt/mimer/lalc/results/correlations/west/Table_phase1_L.h5'
...
#####################save just in case#########################################        
joblib.dump((Lcorr,L10min),'/mnt/mimer/lalc/results/correlations/west/storeL.pkl')
