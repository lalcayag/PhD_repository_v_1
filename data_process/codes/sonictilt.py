# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 10:46:55 2019
Sonic tilt correction
@author: lalc
"""


def tiltCorrection(u,v,w,varargin): 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [b0,b1,b2] = findB(meanU,meanV,meanW)
        ...
        g=[sw suw svw]'  ;
        x=H\g    ;
        fprintf('%10.5f %10.5f %10.5f %6.1f\n',x);
        fprintf('\n');
