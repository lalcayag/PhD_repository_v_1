    ...
    if (len(indt0)>0)&(len(indt1)>0):
        for i0,i1 in zip(indt0,indt1):
            ...
            if len(uo)>0:
                ...
                aux0.to_hdf('/mnt/mimer/lalc/results/correlations/west/phase_2/corr_phase2_d'+suf+'.h5','corr',mode='a',
                            data_columns = aux0.columns,format='table', append = True)
                aux1.to_hdf('/mnt/mimer/lalc/results/correlations/west/phase_2/corr_phase2_d'+suf+'.h5','L',mode='a',
...
file_name = 'C:/Users/lalc/Documents/PhD/Python Code/repository_v1/corr_spec_phase2_d02.h5'
file_name2 = 'C:/Users/lalc/Documents/PhD/Python Code/repository_v1/corr_phase2_d02_2.h5'
...
# L.to_hdf(file_name2,'L',mode='a', data_columns =L.iloc[[0]].reset_index().columns.tolist(),format='table', append = True)

# L = pd.read_hdf(file_name2,where = 'name == name_id & hms >= hms1 & hms <= hms2', key='L')

# data_columns=df.iloc[[0]].reset_index().columns.tolist()
